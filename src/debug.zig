...
pub fn getSelfDebugInfo() !*std.debug.DwarfInfo {
    const S = struct {
...
fn printLineFromBuffer(out_stream: std.io.Writer, contents: []const u8, line_info: std.debug.LineInfo) anyerror!void {
    var line: usize = 1;
    var column: usize = 1;
...
fn printLineFromFile(out_stream: std.io.Writer, line_info: std.debug.LineInfo) anyerror!void {
